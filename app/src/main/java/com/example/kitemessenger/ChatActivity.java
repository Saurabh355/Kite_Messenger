        ...
        mRootRef.child("Users").child(mChatUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default")){
                    ...
                    Picasso.with(ChatActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_profile_pic)
                            .into(mProfileImage, new Callback() {
                                ...
                                public void onError() {
                                    ...
                                    Picasso.with(ChatActivity.this).load(image).placeholder(R.drawable.default_profile_pic).into(mProfileImage);
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Taking chatUser and currentUserName from previous activity********
